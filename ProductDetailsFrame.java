...
public class ProductDetailsFrame extends JFrame {
        ...
        SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
            ...
            protected Boolean doInBackground() {
                try {
                    ...
                    System.out.println("Réponse getProduct: " + response);
                    ...
                    if (parts.length < 7) {
                        System.err.println("Format incorrect: " + response);
                        return false;
                    }
    ...
    private void showProductDetails(String name, double price, String description, int stock, 
        ...
        // Panel principal avec GridBagLayout pour mieux contrôler la disposition
        ...
        // Charger l'image en plus grande taille
        ...
        // Catégorie
        JLabel categoryLabel = new JLabel("📁 Catégorie : " + category);
        ...
        JLabel stockLabel;
        if (stock > 10) {
            stockLabel = new JLabel("✅ En stock : " + stock + " unités");
            stockLabel.setForeground(UITheme.SUCCESS);
        } else if (stock > 0) {
            stockLabel = new JLabel("⚠️ Stock limité : " + stock + " unités");
            stockLabel.setForeground(UITheme.WARNING);
        } else {
            stockLabel = new JLabel("❌ Rupture de stock");
        ...
        JTextArea descriptionArea = new JTextArea(description != null && !description.isEmpty() ? description : "Aucune description disponible.");
        ...
        quantitySpinner.setBackground(UITheme.CARD_2);
        quantitySpinner.setForeground(Color.WHITE);
        ...
        // Ajouter le panel principal au root
        ...
        addCartBtn.addActionListener(e -> {
            if (stock == 0) {
                JOptionPane.showMessageDialog(this, "Produit en rupture de stock !");
                return;
            }
